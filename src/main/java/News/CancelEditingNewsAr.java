...
public class CancelEditingNewsAr extends PageBase {

	public CancelEditingNewsAr(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath="//div[4]/div/div/button")
	WebElement cancel ;
	
	@FindBy(xpath="//button[contains(.,'متابعة')]")
